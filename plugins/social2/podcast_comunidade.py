"""Plugin: podcast_comunidade | social2 | Podcast feito pela comunidade"""
...
class PodcastComunidadePlugin(PluginBase):
    name = "podcast_comunidade"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "podcast_comunidade", "categoria": "social2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
...
plugin = PodcastComunidadePlugin()
