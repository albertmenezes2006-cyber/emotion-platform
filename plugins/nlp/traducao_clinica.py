"""Plugin: traducao_clinica | nlp | Tradução de termos clínicos para linguagem simples"""
...
class TraducaoClinicaPlugin(PluginBase):
    name = "traducao_clinica"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "traducao_clinica", "categoria": "nlp", "total": len(_db), "ts": datetime.utcnow().isoformat()}
