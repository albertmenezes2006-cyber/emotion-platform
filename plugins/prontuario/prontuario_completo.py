"""Plugin: prontuario_completo | prontuario | Prontuário eletrônico completo SOAP"""
...
class ProntuarioCompletoPlugin(PluginBase):
    name = "prontuario_completo"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "prontuario_completo", "categoria": "prontuario", "total": len(_db), "ts": datetime.utcnow().isoformat()}
...
plugin = ProntuarioCompletoPlugin()
