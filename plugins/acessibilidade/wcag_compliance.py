"""Plugin: wcag_compliance | acessibilidade | WCAG 2.1 AA compliance total"""
...
class WcagCompliancePlugin(PluginBase):
    name = "wcag_compliance"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "wcag_compliance", "categoria": "acessibilidade", "total": len(_db), "ts": datetime.utcnow().isoformat()}
