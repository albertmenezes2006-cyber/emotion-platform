"""Plugin: log_autenticacao | auditoria2 | Log de autenticações e falhas"""
...
class LogAutenticacaoPlugin(PluginBase):
    name = "log_autenticacao"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "log_autenticacao", "categoria": "auditoria2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
