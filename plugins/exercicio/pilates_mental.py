"""Plugin: pilates_mental | exercicio | Pilates focado em saúde mental"""
...
class PilatesMentalPlugin(PluginBase):
    name = "pilates_mental"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "pilates_mental", "categoria": "exercicio", "total": len(_db), "ts": datetime.utcnow().isoformat()}
