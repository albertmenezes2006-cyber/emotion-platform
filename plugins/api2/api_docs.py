"""Plugin: api_docs | api2 | Documentação automática OpenAPI 3.0"""
...
class ApiDocsPlugin(PluginBase):
    name = "api_docs"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "api_docs", "categoria": "api2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
