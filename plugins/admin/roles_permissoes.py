"""Plugin: roles_permissoes | admin | Sistema de roles e permissões granulares"""
...
class RolesPermissoesPlugin(PluginBase):
    name = "roles_permissoes"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "roles_permissoes", "categoria": "admin", "total": len(_db), "ts": datetime.utcnow().isoformat()}
