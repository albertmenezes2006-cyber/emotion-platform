"""Plugin: treino_cognitivo | cognitivo | Treino cognitivo com jogos neuropsicológicos"""
...
class TreinoCognitivoPlugin(PluginBase):
    name = "treino_cognitivo"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "treino_cognitivo", "categoria": "cognitivo", "total": len(_db), "ts": datetime.utcnow().isoformat()}
