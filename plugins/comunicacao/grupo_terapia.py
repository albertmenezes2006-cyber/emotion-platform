"""
Plugin: grupo_terapia
Categoria: comunicacao
Descrição: Grupos terapêuticos online com moderação profissional
"""
...
class GrupoTerapiaPlugin(PluginBase):
    name = "grupo_terapia"
    version = "1.0.0"
    description = "Grupos terapêuticos online com moderação profissional"
...
@router.get("/status")
async def status():
    return {"plugin": "grupo_terapia", "categoria": "comunicacao", "total": len(_db), "ts": datetime.utcnow().isoformat()}
