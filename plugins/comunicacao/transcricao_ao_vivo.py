"""
Plugin: transcricao_ao_vivo
Categoria: comunicacao
Descrição: Transcrição em tempo real para sessões terapêuticas
"""
...
router = APIRouter(prefix="/api/v1/transcricao-ao-vivo", tags=["comunicacao"])
_db = {}
...
@router.get("/status")
async def status():
    return {"plugin": "transcricao_ao_vivo", "categoria": "comunicacao", "total": len(_db), "ts": datetime.utcnow().isoformat()}
