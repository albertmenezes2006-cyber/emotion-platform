"""Plugin: monitoramento_ia | ia2 | Monitoramento passivo por IA"""
...
class MonitoramentoIaPlugin(PluginBase):
    name = "monitoramento_ia"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "monitoramento_ia", "categoria": "ia2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
