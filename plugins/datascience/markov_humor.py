"""Plugin: markov_humor | datascience | Cadeias de Markov para transições de humor"""
...
class MarkovHumorPlugin(PluginBase):
    name = "markov_humor"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "markov_humor", "categoria": "datascience", "total": len(_db), "ts": datetime.utcnow().isoformat()}
