"""Plugin: naive_bayes_emocao | datascience | Naive Bayes para triagem emocional rápida"""
...
class NaiveBayesEmocaoPlugin(PluginBase):
    name = "naive_bayes_emocao"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "naive_bayes_emocao", "categoria": "datascience", "total": len(_db), "ts": datetime.utcnow().isoformat()}
