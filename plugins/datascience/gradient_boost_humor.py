"""Plugin: gradient_boost_humor | datascience | Gradient Boosting para modelagem de humor"""
...
class GradientBoostHumorPlugin(PluginBase):
    name = "gradient_boost_humor"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "gradient_boost_humor", "categoria": "datascience", "total": len(_db), "ts": datetime.utcnow().isoformat()}
...
plugin = GradientBoostHumorPlugin()
