"""Plugin: cfm_resolucoes | compliance2 | Resoluções CFM para telemedicina"""
...
class CfmResolucoesPlugin(PluginBase):
    name = "cfm_resolucoes"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "cfm_resolucoes", "categoria": "compliance2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
