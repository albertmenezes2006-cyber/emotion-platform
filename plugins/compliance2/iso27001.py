"""Plugin: iso27001 | compliance2 | ISO 27001 implementação e auditoria"""
...
class Iso27001Plugin(PluginBase):
    name = "iso27001"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "iso27001", "categoria": "compliance2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
