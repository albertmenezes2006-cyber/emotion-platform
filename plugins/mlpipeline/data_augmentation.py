"""Plugin: data_augmentation | mlpipeline | Augmentação de dados emocionais para treino"""
...
class DataAugmentationPlugin(PluginBase):
    name = "data_augmentation"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "data_augmentation", "categoria": "mlpipeline", "total": len(_db), "ts": datetime.utcnow().isoformat()}
