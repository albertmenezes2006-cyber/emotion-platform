"""Plugin: ids_ips | seguranca2 | IDS/IPS — Detecção e prevenção de intrusão"""
...
class IdsIpsPlugin(PluginBase):
    name = "ids_ips"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "ids_ips", "categoria": "seguranca2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
