"""Plugin: retencao_dados | backup2 | Política de retenção de dados"""
...
class RetencaoDadosPlugin(PluginBase):
    name = "retencao_dados"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "retencao_dados", "categoria": "backup2", "total": len(_db), "ts": datetime.utcnow().isoformat()}
