"""Plugin: email_terapeutico | notificacoes | E-mails terapêuticos personalizados"""
...
class EmailTerapeuticoPlugin(PluginBase):
    name = "email_terapeutico"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "email_terapeutico", "categoria": "notificacoes", "total": len(_db), "ts": datetime.utcnow().isoformat()}
