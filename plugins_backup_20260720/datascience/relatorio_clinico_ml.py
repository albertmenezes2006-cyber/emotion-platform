"""
Plugin: relatorio_clinico_ml
Categoria: datascience
Descrição: Relatórios clínicos gerados por ML
"""
...
class RelatorioClinicoMlPlugin(PluginBase):
    ...
    version = "1.0.0"
    description = "Relatórios clínicos gerados por ML"
...
@router.get("/status")
async def status():
    return {"plugin": "relatorio_clinico_ml", "categoria": "datascience", "total": len(_db), "ts": datetime.utcnow().isoformat()}
