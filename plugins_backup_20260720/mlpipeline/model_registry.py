...
Descrição: Registro centralizado de modelos ML com versionamento
"""
...
@router.get("/status")
async def status():
    return {"plugin": "model_registry", "categoria": "mlpipeline", "total": len(_db), "ts": datetime.utcnow().isoformat()}
