"""Plugin: wim_hof | respiracao | Método Wim Hof guiado digitalmente"""
...
class WimHofPlugin(PluginBase):
    name = "wim_hof"; version = "1.0.0"
...
@router.get("/status")
async def status():
    return {"plugin": "wim_hof", "categoria": "respiracao", "total": len(_db), "ts": datetime.utcnow().isoformat()}
